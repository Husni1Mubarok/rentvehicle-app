        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm space-y-4">
              <div className="relative h-[320px] md:h-[400px] w-full rounded-2xl overflow-hidden bg-gray-50 flex items-center justify-center border border-gray-100">
                {primaryImage && (primaryImage.image_url.startsWith('http') || primaryImage.image_url.startsWith('data:')) ? (
          ...
          <div className="lg:col-span-4 sticky top-24">
            <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm space-y-6">
              <h3 className="font-bold text-gray-900 pb-3 border-b border-gray-100">Sewa Kendaraan</h3>

              {/* Pricing Information */}
              <div className="space-y-3 pt-2 text-sm text-gray-500">
                <div className="flex justify-between">
                  <span>Harga Sewa</span>
                  <span className="font-black text-blue-600">Rp {vehicle.price_per_day.toLocaleString('id-ID')} <span className="text-xs font-medium text-gray-400">/hari</span></span>
                </div>
                <div className="flex justify-between">
                  <span>Asuransi & Proteksi</span>
                  <span className="font-bold text-emerald-500">Termasuk</span>
                </div>
                <div className="flex justify-between">
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 text-sm shadow-lg shadow-blue-600/20 mt-4"
              >
                Lanjutkan Pemesanan <span>➔</span>
              </button>

              <p className="text-[10px] text-gray-400 font-medium text-center">Tanggal dan detail sewa akan dipilih pada tahap selanjutnya.</p>
            </div>
          </div>
        </div>
      </div>
